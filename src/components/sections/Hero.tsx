...
const BALLS = [
  { src: "https://res.cloudinary.com/du0witbcr/image/upload/v1782665000/pampered-paws/icons/ball-3.svg", className: "left-[78%] top-[16%] hidden lg:block", toRot: 33, fromX: -70, fromY: 50, fromRot: 45, delay: 0 },
  { src: "https://res.cloudinary.com/du0witbcr/image/upload/v1782664993/pampered-paws/icons/ball-1.svg", className: "left-[80%] top-[54%] hidden lg:block", toRot: -17, fromX: -60, fromY: -50, fromRot: -27, delay: 100 },
  { src: "https://res.cloudinary.com/du0witbcr/image/upload/v1782664994/pampered-paws/icons/ball-2.svg", className: "left-[20%] top-[16%] hidden lg:block", toRot: -30, fromX: 60, fromY: 50, fromRot: -20, delay: 200 },
  { src: "https://res.cloudinary.com/du0witbcr/image/upload/v1782665001/pampered-paws/icons/ball-4.svg", className: "left-[18%] top-[54%] hidden lg:block", toRot: 25, fromX: 60, fromY: -50, fromRot: 35, delay: 300 },
];
...
export function Hero() {
  return (
    <section className="relative flex flex-col items-center gap-3xl overflow-hidden px-lg py-3xl sm:gap-6xl sm:py-6xl lg:gap-7xl lg:py-7xl">
      ...
      <div className="relative z-10 grid w-full max-w-[1240px] grid-cols-1 gap-lg sm:grid-cols-[1fr_1.625fr_1fr] sm:items-stretch">
        <div
